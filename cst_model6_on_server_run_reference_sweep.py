...
project_name = r'model_6_reference_sweep'
...
ants_count = 0
starting_index = 0
for run_ID_local, LG_z in enumerate(LG_z_list):  #15001-starting_index-1 % 15067 is problematic!
