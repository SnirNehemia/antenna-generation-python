...
simulation_name = 'CST_Model_better_parametric_model5' # TODO: change to the name of your .cst file
project_name = ''
...
local_path = r'G:\local_model_5_path\simplified' # TODO: change to the name of directory .cst file


# ant_parameters_names = parametric_ant_utils.get_parameters_names()
data_path = r"G:\optimized_output_avi\model5\optimized_antennas_GNN_iso_005" #"optimized_antennas_GNN_lr_01_gamma_98_with_feed_opt"
...
for model_name in model_names:
    ...
    if name_without_ant in processed_examples:
        continue
    if name_without_ant in bad_ant_list:
        continue
    ...
    #     continue
    print(f'Working on antenna in path: {ant_ID} ')
    # TODO:
    """ LOAD HERE:
    ...
    file_name = models_path + '\\' + str(ant_ID) + '\\model_parameters.pickle'
    file = open(file_name, 'wb')
    pickle.dump(model_parameters, file)
    file.close()
    file_name = models_path + '\\' + str(ant_ID) + '\\ant_parameters.pickle'
    file = open(file_name, 'wb')
