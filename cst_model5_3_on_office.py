...
simulation_name = 'CST_Model_better_parametric_model5_3'
...
local_path = 'G:\\local_model_5_3_path\\'
...
model_parameters = {
    ...
    'Sz':30,#coordinatealongthex(red)axis
    'Sy': 30,
    'w':2,#coordinatealongthev(green)axis
    'thickness':1,
    'feed_length':2,
    'Ly':0,
    'Lz':1,
...
# for model 5_1
# model_parameters_limits['Sz'] = [29,31]
# model_parameters_limits['Sy'] = [29,31]
# model_parameters_limits['Lz'] = [1.9, 2]
# model_parameters_limits['Ly'] = [1.9,2]
# model_parameters_limits['reflector_w'] = [0.5, 1]
# model_parameters_limits['L'] = [499, 501]
model_parameters_limits['rotation_AZ'] = [0.0, 359.0]
model_parameters_limits['rotation_EL'] = [-90, 90]
model_parameters_limits['dist_r'] = [1, 1.5]  # actual distance is dist_r*50
...
ants_count = 0
starting_index = 0
for run_ID_local in range(0, 1000):  #15001-starting_index-1 % 15067 is problematic!
